frappe.ready(function () {
  ...
  // Observe product listing for changes (e.g. filters, sorting) and re-inject offers.
  var observerInitialized = false;
  function setupOffersObserver() {
    ...
    var observer = new MutationObserver(function () {
      ...
      timeoutId = setTimeout(injectProductOffers, 200);
    });

    observer.observe(listing, { childList: true, subtree: true });
  }

  setTimeout(setupOffersObserver, 800);
});
